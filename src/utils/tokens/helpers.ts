...
export const initialNeutronToken: Token = {
	...
	logoURI:
		"https://raw.githubusercontent.com/MikeVerse/assetlist-proxy/main/assets/mainnet/ntrn.png",
	symbol: "NTRN",
...
export const initialUSDCToken: Token = {
	...
	logoURI:
		"https://raw.githubusercontent.com/MikeVerse/assetlist-proxy/main/assets/testnet/tUSDC.png",
	symbol: "tUSDC",
...
export const initialUSTTwoToken: Token = {
	...
	logoURI:
		"https://raw.githubusercontent.com/MikeVerse/assetlist-proxy/main/assets/testnet/UST2.png",
	symbol: "UST2",
...
export const initialAtomToken: Token = {
	...
	logoHash: "LOKC*Nyl}4v,o#kBkCaz|-Z,$xIr",
	logoURI:
		"https://raw.githubusercontent.com/MikeVerse/assetlist-proxy/main/assets/testnet/tATOM.png",
	symbol: "ATOM",
...
export const initialBTCToken: Token = {
	...
	logoHash: "LOKC*Nyl}4v,o#kBkCaz|-Z,$xIr",
	logoURI:
		"https://raw.githubusercontent.com/MikeVerse/assetlist-proxy/main/assets/testnet/tBTC.png",
	symbol: "tBTC",
...
export const initialEleToken: Token = {
	...
	logoHash: "LOKC*Nyl}4v,o#kBkCaz|-Z,$xIr",
	logoURI:
		"https://raw.githubusercontent.com/MikeVerse/assetlist-proxy/main/assets/testnet/unknown.png",
	symbol: "ELE",
