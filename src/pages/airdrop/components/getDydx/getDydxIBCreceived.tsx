...
const DydxIBCreceived = () => {
	const { address, isWalletConnected } = useChain("dydx")
		...
		const fetchPercentage = async (): Promise<void> => {
			try {
				const response = await axios.get<AddressData[]>(
					"https://raw.githubusercontent.com/Electron-Protocol/airdrop/main/Dydx/Dydx_percentage_IBCreceived.json"
				)
...
export default DydxIBCreceived
