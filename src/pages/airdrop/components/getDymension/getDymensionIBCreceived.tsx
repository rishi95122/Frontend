		...
		const fetchPercentage = async (): Promise<void> => {
			try {
				const response = await axios.get<AddressData[]>(
					"https://raw.githubusercontent.com/Electron-Protocol/airdrop/main/Dymension/Dymension_percentage_IBCreceived.json"
				)
...
export default DymensionIBCreceived
