...
export const JungleLootPanel = () => {
	...
	return (
		...
		>
			<BlurImage
				src="/assets/games/lottery.png"
				blurHash="LK6^LwMLHa%yufVaVGtjH[oKt5Sh"
			...
			<motion.div
				...
				style={{
					backgroundImage: "linear-gradient(0deg, rgba(100, 230, 230, 0.6), transparent)",
					bottom: "0",
					position: "absolute",
					width: "100%"
				}}
