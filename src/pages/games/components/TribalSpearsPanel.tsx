...
export const TribalSpearsPanel = () => {
	...
	return (
		...
		>
			<BlurImage
				src="/assets/games/tribal.png"
				blurHash="L75Z]tQ-D4yD*KWrLzsVmRksUbVs"
			...
			<motion.div
				...
				style={{
					backgroundImage: "linear-gradient(0deg, rgba(255, 60, 100, 0.8), transparent)",
					bottom: "0",
					position: "absolute",
					width: "100%"
				}}
